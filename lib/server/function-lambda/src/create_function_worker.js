...
const fastSwap_js = Fs.readFileSync(Path.join(__dirname, '../lambda/executor/fastSwap.js'), { encoding: 'utf8' });
  ...
  let builder_invoke_params = {
    ...
    Payload: JSON.stringify({
      ...
      internal_files: {
        ...
        'fastSwap.js': fastSwap_js, // Utility file for spec overrides
      },
...
function delete_module_builder(name, ctx, cb) {
 ...
 || ctx.options.internal.build_plan === 'fast_override'}
