...
export function create_function_worker(status, registry, authorization, cb) {
  ...
  return Async.series(
    ...
    (e) => {
      if (e) {
        console.log(`LOGGING ERROR (create_function_worker):`, e);
...
function compile_missing_dependency(name, ctx, cb) {
  ...
  return Async.series(
    ...
    (e) => {
      if (e) {
        console.log(`LOGGING ERROR (compile_missing_dependency): `, e);
        return cb(e);
      }
    }
  );
  ...
  function create_module_builder_then_compile(delete_before_creating) {
    return Async.series(
      ...
      (e) => {
        if (e) {
          console.log(`LOGGING ERROR (create_module_builder_then_compile): `, e);
  ...
  function module_compile_pass(is_final) {
    return Common.Lambda.invoke(builder_invoke_params, async (e, d) => {
      if (e) {
        console.log(`LOGGING ERROR (module_compile_pass, invoke): ${e.code}`, e);
