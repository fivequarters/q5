...
function update_tasks(ctx, cb) {
  ...
  const getMissingRoutes = (routes, missingIn) => routes.filter((r) => !missingIn.some((r1) => r1 === r));
  const getCommonRoutes = (routes1, routes2) => routes1.filter((r) => routes2.some((r2) => r2 === r));
