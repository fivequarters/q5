...
function create_new_user_function(ctx, cb) {
  ...
  return Common.Lambda.createFunction(create_function_params, async (e, d) => {
    ...
    if (
      d.State === 'Pending' &&
      (await waitForFunctionAndCheckForError(ctx.options, 'function builder', functionName, (e) =>
        cb(normalize_function_error(e))
      ))
    ) {
      return;
...
async function waitForFunctionAndCheckForError(options, functionType, functionName, cb) {
    ...
    return Common.Lambda.invoke(builder_invoke_params, async (e, d) => {
      if (e) {
        ...
        if (e.code === 'ResourceConflictException') {
          ...
          if (
            await waitForFunctionAndCheckForError(ctx.options, 'module builder', functionName, (e) =>
              update_module_metadata_and_finish(e)
            )
          ) {
            return;
          } else {
    ...
    return Common.Lambda.invoke(builder_invoke_params, async (e, d) => {
      if (e) {
        ...
        if (e.code === 'ResourceConflictException') {
          ...
          if (await waitForFunctionAndCheckForError(ctx.options, 'function builder', functionName, (e) => cb(e))) {
            return;
          } else {
...
function create_function_builder(options, cb) {
  ...
  return Common.Lambda.createFunction(create_builder_params, async (e, d) => {
    ...
    return d.State === 'Pending' &&
      (await waitForFunctionAndCheckForError(options, 'function builder', functionName, cb))
      ? undefined
      : cb();
  });
}
...
function create_module_builder(name, ctx, cb) {
  ...
  return Common.Lambda.createFunction(create_builder_params, async (e, d) => {
    ...
    return d.State === 'Pending' &&
      (await waitForFunctionAndCheckForError(ctx.options, 'module builder', functionName, cb))
      ? undefined
      : cb();
  });
}
