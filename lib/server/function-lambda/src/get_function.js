...
const { convert_spec_to_tags } = require('@5qtrs/function-tags');
const create_error = require('http-errors');

export function get_function(req, res, next) {
  return get_function_core(req.params, (e, functionSpec) => {
    if (e) {
      if (e.code === 'NoSuchKey') {
...
function get_function_core(options, cb) {
  Assert.ok(options);
  ...
  return Common.S3.getObject(
    ...
    (e, d) => {
      ...
      d.Body.runtime = { tags: convert_spec_to_tags(d.Body) };
