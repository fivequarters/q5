...
exports.get_user_function_build_status_key = function get_user_function_build_status_key(options) {
  return `${exports.function_build_status_key_prefix}/${options.subscriptionId}/${options.boundaryId}/${
    options.functionId
  }/${options.buildId}.json`;
};

exports.get_user_function_build_request_key = function get_user_function_build_request_key(options) {
  return `${exports.function_build_request_key_prefix}/${options.subscriptionId}/${options.boundaryId}/${
    options.functionId
  }/${options.buildId || options.id}.json`;
};

exports.get_user_function_build_key = function get_user_function_build_key(options) {
  return `${exports.function_build_key_prefix}/${options.subscriptionId}/${options.boundaryId}/${
    options.functionId
  }/package.zip`;
};

exports.get_user_function_spec_key = function get_user_function_spec_key(options) {
  return `${exports.function_spec_key_prefix}/${options.subscriptionId}/${options.boundaryId}/${
    options.functionId
  }/spec.json`;
};
...
exports.get_user_function_name = function get_user_function_name(options) {
  return Crypto.createHash('sha1')
    .update(exports.get_user_function_description(options))
    .digest('hex');
};
...
exports.get_function_location = function get_function_location(baseUrl, subscriptionId, boundaryId, functionId) {
  return `${baseUrl}/api/v1/run/${subscriptionId}/${boundaryId}/${functionId}`;
};
