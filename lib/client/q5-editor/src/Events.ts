...
/**
 * Names of the events generated by the [[Workspace]] class.
 */
export enum Events {
  /**
  ...
  /**
   * Dirty state of the workspace has changed. Event data has [[DirtyStateChangedEvent]] type.
   */
  DirtyStateChanged = 'dirty-state:changed',
  /**
   * Read-only state of the workspace has changed. Event data has [[ReadOnlyStateChangedEvent]] type.
   */
...
/**
 * Base interface implemented by all events generated by the [[Workspace]] class.
 */
...
/**
 * Dirty state of the [[Workspace]] has changed.
 */
...
/**
 * The read only state of the workspace has changed.
 */
