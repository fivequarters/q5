...
import { Events, FileSelectedEvent, SettingsComputeSelectedEvent, SettingsApplicationSelectedEvent } from './Events';
import * as Monaco from 'monaco-editor/esm/vs/editor/editor.api.js';
import { IEditorPanelOptions, EditorPanelOptions } from './Options';
...
export function createEditorPanel (element: HTMLElement, workspace: Workspace, options?: IEditorPanelOptions) {
    ...
    workspace.on(Events.SettingsComputeSelected, function (_) {
        ...
        computeSettings = computeSettings || serializeKeyValue((workspace.functionSpecification.lambda || {}), SettingsComputePlaceholder);
    ...
    workspace.on(Events.SettingsApplicationSelected, function (_) {
        ...
        applicationSettings = applicationSettings || serializeKeyValue((workspace.functionSpecification.configuration || {}), SettingsApplicationPlaceholder);
