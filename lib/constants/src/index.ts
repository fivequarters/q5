...
const GRAFANA_PROMOTED_STACK_SSM_KEY = '/fusebit/grafana/promoted/';

const FUSEBIT_DISCOVERY_NS_POSTFIX = 'fusebit.internal';

const GRAFANA_DISCOVERY_PREFIX = 'discovery-';
...
export {
  ...
  GRAFANA_PROMOTED_STACK_SSM_KEY,
  GRAFANA_DISCOVERY_PREFIX,
  API_PUBLIC_HOST,
