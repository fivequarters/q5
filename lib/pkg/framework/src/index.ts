...
import IntegrationActivator_ from './IntegrationActivator';
...
const Internal = {
  ...
  Storage: Storage_,
  IntegrationActivator: IntegrationActivator_,
  Tenant: Tenant_,
};
...
module Internal {
  ...
  export type IntegrationActivator = typeof IntegrationActivator_;
