 ...
 */
export default class OAuthIntegration extends IntegrationActivator<{ accessToken: string }> {
  /*
   ...
   */
  protected async instantiate(ctx: Context, lookupKey: string): Promise<{ accessToken: string }> {
