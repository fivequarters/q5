...
exports.dispatch_event = (e) => {
  ...
  let attributes = convertUrlToAttributes(`${Constants.API_PUBLIC_ENDPOINT}${e.request.url}`);

  // Now include all of the Fusebit-internal spans
  attributes.push(...[...e.functionSpans.map((span) => convertUrlToAttributes(span.url))]);
