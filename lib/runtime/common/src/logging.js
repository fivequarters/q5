...
const addLogging = (keyStore) => {
  ...
  */
    ...
    console.log(
      `Log ${req.params.boundaryId}/${req.params.functionId} to ${protocol}://${host} with traceId ${req.traceId}`
    );
...
// XXX add additional parameters here including the traceid for this request.
