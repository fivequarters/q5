        ...
        <Drawer width="100%" background={FusebitColor.black} height={420} open={drawerOpen} vertical rate={20}>
          <Box vertical width="100%" marginTop={20} gap={20}>
            ...
            <Box marginBottom={20} stretch>
              <FusebitButton expand onClick={onLetsTalkClickedWrapped} gaCategory="CTA" gaAction="Clicked main button" gaLabel={location.pathname} >
                Get started
              </FusebitButton>
  ...
  function NonMobileVersion() {
    return (
      <Box right middle width="100%" padding={20} maxWidth={maxWidth || 1200}>
        ...
        <FusebitButton marginLeft={30} onClick={onLetsTalkClickedWrapped} gaCategory="CTA" gaAction="Clicked main button" gaLabel={location.pathname}>
          Get started
        </FusebitButton>
      </Box>
    );
