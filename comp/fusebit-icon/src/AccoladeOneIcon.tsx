...
export type AccoladeOneIconProps = {
  size?: number;
  color?: FusebitColor;
} & BoxProps;
...
export function AccoladeOneIcon({ size, color, expand, ...rest }: AccoladeOneIconProps) {
  ...
  return (
    <Box center middle expand={!size} {...rest}>
      <svg width={size || '100%'} height={size || '100%'} viewBox="0 0 43 39" fill="none">
        ...
        />
        <path
          d="M18.0638 24.168C20.6818 24.168 22.4318 21.942 22.4318 19.1C22.4318 16.23 20.6818 14.032 18.0918 14.032C15.4878 14.032 13.7238 16.258 13.7238 19.1C13.7238 21.97 15.4458 24.168 18.0638 24.168ZM18.0918 22.222C16.7898 22.222 15.9358 20.892 15.9358 19.1C15.9358 17.28 16.7758 15.978 18.0638 15.978C19.3518 15.978 20.2198 17.322 20.2198 19.1C20.2198 20.906 19.3938 22.222 18.0918 22.222ZM25.618 24H27.746V14.13H26.276L23.462 14.97L23.91 16.734L25.618 16.314V24Z"
          fill={color || FusebitColor.dark}
        />
      </svg>
    </Box>
