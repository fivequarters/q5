...
router.post('/api/tenant/:tenantId/test', integration.middleware.authorizeUser('instance:put'), async (ctx) => {
  /*
   * You can use the Slack SDK by referencing the connector name 'slackConnector' you provided in the data.component[0].name field.
   ...
   * All of the Slack Web API is available here, you can read about them at https://www.npmjs.com/package/@slack/web-api
   */
