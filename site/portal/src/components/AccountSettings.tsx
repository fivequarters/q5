...
function AccountSettings() {
  ...
  const [defaultResource, setDefaultResource] = React.useState<any>(createInitialResource());
    ...
    <React.Fragment>
      ...
      <Grid container spacing={2} className={classes.gridContainer}>
        ...
        <Grid item xs={4}>
          ...
          <InfoCard>These settings determine the resource you will first see when you switch to this account.</InfoCard>
        </Grid>
      </Grid>
      <Grid container spacing={2} className={classes.gridContainer}>
        <Grid item xs={8} className={classes.inputField}>
          <Button color="secondary" variant="contained" disabled={!isDirty() || hasError()} onClick={handleSave}>
            Save
          </Button>
          <Button
            variant="text"
