...
import { FusebitText as Text, FusebitTextType as TextType, FusebitTextType as TextWeight } from '@5qtrs/fusebit-text';
...
export function Terms() {
  return (
    <Page header="Terms of Use" updatedOn="August 9, 2019">
      <Section header="AGREEMENT TO TERMS">
        These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of
        an entity (“<strong>you</strong>”) and Five Quarters LLC, doing business as Fusebit (“<strong>Fusebit</strong>
        ”, “<strong>we</strong>”, “<strong>us</strong>”, or “<strong>our</strong>”), concerning your access to and use
        of the{' '}
        <Link noVisit to="/">
          https://fusebit.io
        </Link>{' '}
        website as well as any other media form, media channel, mobile website or mobile application related, linked, or
        otherwise connected thereto (collectively, the “<strong>Site</strong>”). You agree that by accessing the Site,
        ...
        updates. You will be subject to, and will be deemed to have been made aware of and to have accepted, the changes
      ...
      <Section header="INTELLECTUAL PROPERTY RIGHTS">
      ...
      <Section header="USER REPRESENTATIONS">
        ...
        of Use; (4) you are not under the age of 13; (5) you are not a minor in the jurisdiction in which you reside, or
        if a minor, you have received parental permission to use the Site (6) you will not access the Site through
        automated or non-human means, whether through a bot, script, or otherwise; (7) you will not use the Site for any
        illegal or unauthorized purpose; and (8) your use of the Site will not violate any applicable law or regulation.
        <Break />
      ...
      <Section header="PROHIBITED ACTIVITIES">
      ...
      <Section header="USER GENERATED CONTRIBUTIONS">
        ...
        to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other
        material (collectively, "Contributions"). Contributions may be viewable by other users of the Site and through
      ...
      <Section header="CONTRIBUTION LICENSE">
      ...
      <Section header="SOCIAL MEDIA">
        ...
        granting us access to any Third-Party Accounts, you understand that (1) we may access, make available, and store
        (if applicable) any content that you have provided to and stored in your Third-Party Account (the “Social
        Network Content”) so that it is available on and through the Site via your account, including without limitation
        any friend lists and (2) we may submit to and receive from your Third-Party Account additional information to
        ...
        Accounts, personally identifiable information that you post to your Third-Party Accounts may be available on and
        through your account on the Site. Please note that if a Third-Party Account or associated service becomes
        unavailable or our access to such Third Party Account is terminated by the third-party service provider, then
        Social Network Content may no longer be available on and through the Site. You will have the ability to disable
        the connection between your account on the Site and your Third-Party Accounts at any time. PLEASE NOTE THAT YOUR
        ...
        the Site. You can deactivate the connection between the Site and your Third-Party Account by contacting us using
        the contact information below or through your account settings (if applicable). We will attempt to delete any
      ...
      <Section header="THIRD-PARTY WEBSITES AND CONTENT">
        ...
        Third-Party Content, you do so at your own risk, and you should be aware these Terms of Use no longer govern.
        ...
        Third-Party Websites and you shall hold us harmless from any harm caused by your purchase of such products or
      ...
      <Section header="PRIVACY POLICY">
        ...
        <Link noVisit to="https://fusebit.io/privacy">
          https://fusebit.io/privacy
        </Link>
        . By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use.
        Please be advised the Site is hosted in the United States. If you access the Site from the European Union, Asia,
        or any other region of the world with laws or other requirements governing personal data collection, use, or
        ...
        and processed in the United States. Further, we do not knowingly accept, request, or solicit information from
        children or knowingly market to children. Therefore, in accordance with the U.S. Children’s Online Privacy
        Protection Act, if we receive actual knowledge that anyone under the age of 13 has provided personal information
        to us without the requisite and verifiable parental consent, we will delete that information from the Site as
        quickly as is reasonably practical.
      </Section>

      <Section header="TERM AND TERMINATION">
      ...
      <Section header="MODIFICATIONS AND INTERRUPTIONS">
      ...
      <Section header="GOVERNING LAW">
        ...
        State of Washington applicable to agreements made and to be entirely performed within the State of Washington,
        without regard to its conflict of law principles.
      </Section>

      <Section header="DISPUTE RESOLUTION">
        <Text type={TextType.header4}>Informal Negotiations</Text>
        <Break />
        ...
        <Break />
        <Text type={TextType.header4}>Binding Arbitration</Text>
        <Break />
        ...
        The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by
        ...
        take place in USA County, Washington. Except as otherwise provided herein, the Parties may litigate in court to
        compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate or enter judgment on the
        ...
        prosecuted in the state and federal courts located in USA County, Washington, and the Parties hereby consent to,
        ...
        court.
        <Break />
        <Text type={TextType.header4}>Restrictions</Text>
        <Break />
        ...
        <Break />
        <Text type={TextType.header4}>Exceptions to Informal Negotiations and Arbitration</Text>
        <Break />
      ...
      <Section header="LIMITATIONS OF LIABILITY">
        ...
        IF ANY, BY YOU TO US DURING THE SIX (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN STATE LAWS DO
        NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS
        APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE
        ADDITIONAL RIGHTS.
      </Section>

      <Section header="INDEMNIFICATION">
      ...
      <Section header="ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES">
      ...
      <Section header="CALIFORNIA USERS AND RESIDENTS">
