(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("q5hook", [], factory);
	else if(typeof exports === 'object')
		exports["q5hook"] = factory();
	else
		root["q5hook"] = factory();
})(this, function() {
...
// module
exports.push([module.i, ".q5-hook-editor-container {\n    width: 100%; \n    height: 100%; \n    position: fixed; \n    top: 0; \n    left: 0; \n    border: 0px;\n    z-index: 9999; \n    background: transparent;\n}\n", ""]);
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ./q5-hook.css */ "./lib/q5-hook.css");
function edit(options) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let contentWindow = document.getElementById(editorFrameId).contentWindow;
        ...
        function onMessage(event) {
            ...
            switch (request) {
                ...
                default:
                    closeModal();
                    reject(new Error(`Unsupported request from Q5 Hook Editor: ${request}. Make sure the version of the q5-hook.js you are using is up to date.`));
            }
        }
        function closeModal() {
...
var content = __webpack_require__(/*! !../../../../node_modules/css-loader!./q5-hook.css */ "../../../node_modules/css-loader/index.js!./lib/q5-hook.css");
...
//# sourceMappingURL=q5hook.js.map