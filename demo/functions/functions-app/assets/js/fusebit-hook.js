(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("fusebitHook", [], factory);
	else if(typeof exports === 'object')
		exports["fusebitHook"] = factory();
	else
		root["fusebitHook"] = factory();
})(this, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./libm/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "../../../node_modules/css-loader/dist/cjs.js!./libm/fusebit-hook.css":
/*!********************************************************************************************!*\
  !*** /Users/tomek/projects/q5/node_modules/css-loader/dist/cjs.js!./libm/fusebit-hook.css ***!
  \********************************************************************************************/
...
// Module
exports.push([module.i, ".fusebit-hook-editor-container {\n  width: 100%;\n  height: 100%;\n  position: fixed;\n  top: 0;\n  left: 0;\n  border: 0px;\n  z-index: 9999;\n  background: transparent;\n}\n", ""]);
...
/*!****************************************************************************!*\
  !*** /Users/tomek/projects/q5/node_modules/css-loader/dist/runtime/api.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var content = __webpack_require__(/*! !../../../../node_modules/css-loader/dist/cjs.js!./fusebit-hook.css */ "../../../node_modules/css-loader/dist/cjs.js!./libm/fusebit-hook.css");
...
/* harmony import */ var _fusebit_hook_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fusebit-hook.css */ "./libm/fusebit-hook.css");
/* harmony import */ var _fusebit_hook_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_fusebit_hook_css__WEBPACK_IMPORTED_MODULE_0__);
...
function edit(options) {
    ...
    if (!options.accountResolver) {
        if (options.accessToken && options.baseUrl && options.subscriptionId && options.accountId) {
            // @ts-ignore
            options.accountResolver = account => Promise.resolve({
            ...
            throw new Error('either options.accountResolver or options.accessToken, options.baseUrl, options.subscriptionId, and options.accountId must be specified.');
        }
    }
    ...
    return new Promise((resolve, reject) => {
        ...
        const contentWindow = document.getElementById(editorFrameId).contentWindow;
            ...
            switch (request) {
                ...
                case 'resolveAccount':
                    ...
                    options.accountResolver(event.data).then(account => {
                        ...
                        contentWindow.postMessage(Object.assign({}, account, { requestId: event.data.requestId }), '*');
                    });
                    break;
                case 'closed':
                    closeModal();
...
//# sourceMappingURL=fusebit-hook.js.map